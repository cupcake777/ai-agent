...
class TestConfig:
    def test_memory_eval_env_disables_auto_retain_but_keeps_recall(self, provider_with_config, monkeypatch):
    ...
    def test_memory_eval_env_blocks_explicit_retain(self, provider_with_config, monkeypatch):
        monkeypatch.setenv("HERMES_MEMORY_EVAL", "1")
