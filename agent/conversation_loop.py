...
def _downshift_context_for_fallback_if_needed(
    ...
    *,
    ...
    """Activate fallback and compact first when the current request won't fit."""
            ...
            try:
                ...
                if _should_fallback and agent._fallback_index < len(agent._fallback_chain):
                    ...
                    if not pool_may_recover:
                        ...
                        _fb_activated, messages, active_system_prompt = (
                            _downshift_context_for_fallback_if_needed(
                                agent,
                                messages,
                                api_messages,
